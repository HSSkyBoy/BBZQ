...
/**
 * Fakes Wi-Fi network state to Bilibili so that mobile data/cellular networks
 * are treated as unmetered Wi-Fi, completely bypassing client-side quality downgrade
 * and fallback to 1080P.
 */
