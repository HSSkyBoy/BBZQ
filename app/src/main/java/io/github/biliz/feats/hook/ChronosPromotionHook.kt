...
import io.github.biliz.feats.isAssignableFromBoxed
import io.github.biliz.feats.setObjectField
import io.github.biliz.feats.symbol.RestoredChronosPromotionSymbols
...
class ChronosPromotionHook(env: RoamingEnv) : BaseRoamingHook(env) {
    ...
    override fun startHook() {
        ...
        if (installed == 0) {
            ...
            isInstalled = true
            log("startHook: ChronosPromotion installed $installed hook point(s), initialEnabled=${ModuleSettings.isBlockChronosPromotionEnabled(prefs)}")
        }
    }
