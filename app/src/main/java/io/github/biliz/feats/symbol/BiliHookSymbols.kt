...
data class SkipVideoAdProgressSymbols(
    val progressOnDraw: MethodDescriptor? = null,
    val playerSeekAttachMethods: List<MethodDescriptor> = emptyList(),
    ...
    fun toJson(): JSONObject = JSONObject()
        ...
        .put("playerSeekAttachMethods", playerSeekAttachMethods.toJsonArray { it.toJson() })
    ...
    fun restore(classLoader: ClassLoader): RestoredSkipVideoAdProgressSymbols? {
        return RestoredSkipVideoAdProgressSymbols(
            ...
            playerSeekAttachMethods = playerSeekAttachMethods.mapNotNull { it.restoreOptional(classLoader) },
    ...
    companion object {
        fun fromJson(obj: JSONObject): SkipVideoAdProgressSymbols = SkipVideoAdProgressSymbols(
            ...
            playerSeekAttachMethods = obj.optJSONArray("playerSeekAttachMethods")?.toList {
                MethodDescriptor.fromJson(it)
            } ?: emptyList(),
...
data class RestoredSkipVideoAdProgressSymbols(
    ...
    val playerSeekAttachMethods: List<Method> = emptyList(),
