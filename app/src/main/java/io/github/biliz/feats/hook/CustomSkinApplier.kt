...
internal object CustomSkinApplier {
    ...
    fun applyIfChanged(env: RoamingEnv) {
        ...
        }.apply { name = "BILIZ-CustomSkin" }.start()
    }
    ...
    private fun registerThemeChangeObserver(env: RoamingEnv) {
        ...
        runCatching {
            ...
            env.log("Custom skin observer registration failed", it)
        }
    }
    ...
    private fun scheduleReapply(env: RoamingEnv) {
        ...
        }.apply { name = "BILIZ-CustomSkinReapply" }.start()
    }
    ...
    private const val EXTRA_SELF_APPLIED = "io.github.biliz.extra.SELF_APPLIED_GARB"
}
