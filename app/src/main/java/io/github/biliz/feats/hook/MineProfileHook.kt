...
import io.github.biliz.feats.symbol.RestoredMineProfileSymbols
    ...
    private fun purifyMineData(mineData: Any) = runCatching {
        ...
        if (sectionListV2Field != null) {
            ...
            sections?.forEach { section ->
                ...
                if (ModuleSettings.isMineListStyleEnabled(prefs)) {
                    runCatching {
                        val styleField = section.javaClass.getDeclaredField("style").apply { isAccessible = true }
                        styleField.set(section, 2)
                    }
                }
