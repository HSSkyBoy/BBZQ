...
import io.github.biliz.feats.symbol.RestoredVideoDetailBannerAdSymbols
...
class VideoDetailBannerAdHook(env: RoamingEnv) : BaseRoamingHook(env) {
    ...
    override fun startHook() {
        ...
        // 1. Controller Layer: Direct VDPausedPage Hooks (Pause Ads)
        installed += installVDPausedPageDirectBlock()

        // 3. Business Scope Layer: GAdVideoDetail Class Hooks (Safe Direct Method Hooks without Proxy)
